...
class Simulation:
    ...
    def __init__(self, user_input_dict: dict):
        ...
        self.water = Water(
            init_water_saturation=SimulationConstants.Initial_Water_Saturation.value,
            init_residual_aqueous_saturation=SimulationConstants.Resid_Aqueous_Phase_Saturation_Initial.value,
            init_residual_oleic_saturation=SimulationConstants.Resid_Oleic_Phase_Saturation_Initial.value,
